...
const popupOpenBtns = document.querySelectorAll('.card__add');
const popupOrderBtn = document.querySelector('.popup__order-btn');
const popupSec = document.querySelector(".popup.sec");
const closePopupSec = document.querySelector('.popup.sec .popup__close')

for(let i of popupOpenBtns) i.addEventListener('click', ()=>{
  popup.classList.add("popup--open");
  body.classList.add("lock");
  popupContainerFill();
})
...
popupOrderBtn.addEventListener('click', ()=>{
  popupSec.classList.add("popup--open");
  body.classList.add("lock");
  popup.classList.remove("popup--open");
  body.classList.remove("lock");
})
...
closePopupSec.addEventListener('click', ()=>{
  popupSec.classList.remove("popup--open");
  body.classList.remove("lock");
})
